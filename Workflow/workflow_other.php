...
<head>
    ...
    <style>
        .modal-overlay { display:none; position:fixed; inset:0; background:rgba(0,0,0,0.65); z-index:999; align-items:center; justify-content:center; backdrop-filter:blur(3px); }
        .modal-overlay.active { display:flex; }
        .modal-content { background:var(--bg-card); border-radius:16px; padding:0; max-width:640px; width:92%; box-shadow:0 20px 60px rgba(0,0,0,0.35); border:1px solid var(--border); display:flex; flex-direction:column; max-height:90vh; overflow:hidden; }
        .modal-header { display:flex; justify-content:space-between; align-items:center; padding:22px 26px 18px; border-bottom:1px solid var(--border); flex-shrink:0; }
        .modal-header-left { display:flex; align-items:center; gap:12px; }
        .modal-icon-wrap { width:40px; height:40px; border-radius:10px; display:flex; align-items:center; justify-content:center; font-size:1.1rem; flex-shrink:0; }
        ...
        .modal-close { background:none; border:none; font-size:1.2rem; color:var(--text-sub); cursor:pointer; width:34px; height:34px; display:flex; align-items:center; justify-content:center; border-radius:8px; transition:background 0.18s; flex-shrink:0; }
        ...
        .modal-form-group label { display:flex; align-items:center; gap:7px; margin-bottom:10px; font-weight:600; color:var(--text-main); font-size:0.9rem; }
        .modal-form-group label i { color:var(--primary); font-size:0.85rem; }
        .modal-form-group textarea { width:100%; padding:14px 16px; border:1.5px solid var(--border); border-radius:10px; resize:vertical; min-height:140px; max-height:340px; font-family:inherit; font-size:0.92rem; line-height:1.7; background:var(--bg-body); color:var(--text-main); box-sizing:border-box; transition:border-color 0.18s, box-shadow 0.18s; }
        .modal-form-group textarea:focus { outline:none; border-color:var(--primary); box-shadow:0 0 0 3px rgba(79,70,229,0.12); }
        .modal-form-group textarea::placeholder { color:var(--text-sub); opacity:0.55; }
        .char-counter { text-align:right; font-size:0.75rem; color:var(--text-sub); margin-top:5px; }
        .char-counter.warn { color:#f59e0b; }
        .char-counter.over { color:#ef4444; font-weight:700; }
        .modal-footer { display:flex; gap:10px; justify-content:flex-end; padding:16px 26px 20px; border-top:1px solid var(--border); flex-shrink:0; }
        .modal-btn { padding:10px 22px; border-radius:9px; border:none; font-weight:700; font-size:0.87rem; cursor:pointer; transition:all 0.18s; display:inline-flex; align-items:center; gap:7px; }
        ...
        .comment-box { background:rgba(79,70,229,0.05); border:1px solid rgba(79,70,229,0.15); border-left:3px solid var(--primary); border-radius:8px; padding:10px 13px; margin-top:8px; font-size:0.82rem; line-height:1.65; color:var(--text-main); word-break:break-word; max-height:110px; overflow-y:auto; white-space:pre-wrap; }
        ...
        .comment-expand-btn { background:none; border:none; padding:0; font-size:0.73rem; color:var(--primary); cursor:pointer; font-weight:600; display:inline-flex; align-items:center; gap:4px; margin-top:4px; opacity:0.8; transition:opacity 0.15s; }
        .comment-expand-btn:hover { opacity:1; }
        .comment-label { display:flex; align-items:center; gap:5px; font-weight:700; color:var(--text-sub); font-size:0.78rem; margin-bottom:4px; text-transform:uppercase; letter-spacing:0.04em; }
...
<body>
    ...
    <script>
        ...
        document.getElementById('noteForm').addEventListener('submit', function(e) {
            ...
            let payload = { type: currentAction.type, table: currentAction.table, is_custom: currentAction.is_custom };
