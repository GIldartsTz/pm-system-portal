...
<nav class="sidebar" id="sidebar">
    <div class="nav">
        ...
        <a href="<?=$p?>Hardware_log/hardware.php" class="nav-link <?=($current_page=='hardware')?'active':''?>">
            <i class="fa-solid fa-microchip"></i> <span>Hardware Logs</span>
        </a>
        <a href="<?=$p?>Software_log/software.php" class="nav-link <?=($current_page=='software')?'active':''?>">
            <i class="fa-brands fa-windows"></i> <span>Software Logs</span>
        </a>
        </a>
