...
$task_headers = [];
$q_task = $conn->query("SELECT * FROM master_tasks WHERE system_type='network' ORDER BY id ASC");
...
} else { $task_headers = ["task_1"=>"Check bandwidth usage (Default)"]; }
...
$master_eq = $conn->query("SELECT equipment_name FROM master_equipment WHERE system_type='network'");
...
<head>
    ...
    <link rel="stylesheet" href="../Network_log/css/network.css">
...
<body> 
    ...
    <script src="../Network_log/js/network.js"></script>
</body>
</html>